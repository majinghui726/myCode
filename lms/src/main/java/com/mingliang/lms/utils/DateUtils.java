...
public class DateUtils {
	...
	public static String ZERO_DATE_TIME = "yyyy-MM-dd 00:00:00";
	public static String DATE_TIME1 = "yyyy-MM-dd HH.mm.ss";
	public static String DATE_TIME2 = "yyyy/MM/dd HH:mm:ss";
	public static String DATE_TIME3 = "yyyyMMddHHmmss";
	...
	public static Date strToDate(String datestr) {
	    ...
	    try {
	      ...
	      date = DateUtils.strToDate(datestr,"yyyyMMdd");
	    }
	    return date;
	}
	...
	public static String getBirthDayFromIDCard(String idno) {
	    ...
	    return DateUtils.dateToStr(cd.getTime());
	}
	...
	public static Date chgObject(Object date){
	    ...
	    if(date != null && date instanceof String){
	      return DateUtils.strToDate((String)date);
	    }
	    return null;
	}
	...
	public static long getAgeByBirthday(String date){
	    Date birthday = strToDate(date, DateUtils.DATE_FORMAT);
...
//		long s = DateUtils.getAgeByBirthday("2009-02-15");
//		int s = DateUtils.calcAge(2009-02-15 , 2018-02-15);
//		Date s = DateUtils.strToDate("2009-02-15");
